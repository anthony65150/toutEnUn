...
<?php if ($current_page !== 'connexion.php'): ?>
    ...
    <div class="collapse navbar-collapse d-md-none fond-gris text-center" id="navbarBurgerMenu">
        <ul class="navbar-nav ms-auto mb-2 mb-md-0 d-md-none">
            ...
            <?php if (
                isset($_SESSION['utilisateurs']['fonction']) &&
                in_array($_SESSION['utilisateurs']['fonction'], ['administrateur', 'chef'])
            ) : ?>
                <li class="p-2">
            ...
            <?php if (
                ...
                <li class="p-2">
                    <a href="/stock.php" class="nav-link <?= ($current_page == 'stock.php') ? 'active' : '' ?> text-center">
                        Stock
                    </a>
                </li>
            <?php endif; ?>
